...
L["OUT_OF_DATE"] = "L'addon GlyphFinder n'est pas à jour, veuillez vérifier s'il existe une mise à jour."
L["COMPLETE"] = "Terminé"
L["REQUIRES_TOMTOM"] = "GlyphFinder nécessite l'addon TomTom."
L["AUTO_OFF"] = "Le suivi automatique vers le point de passage le plus proche est désactivé."
L["AUTO_ON"] = "Le suivi automatique vers le point de passage le plus proche est activé."
